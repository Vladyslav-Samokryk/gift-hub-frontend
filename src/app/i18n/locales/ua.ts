export const ua: AllLocalesType = {
  translation: {
    about_as_section: {
      title: "Познайомся з нашою командою!",
      participants: [
        "Владислав Самокрик",
        "Владислава Чайка",
        "Ілона Недзельська",
      ...
      project_info:
        "Ми працювали над нашим проєктом на протязі 7 місяців. Це онлайн магазин подарунків для ІТ спеціалістів. Ми молодці і зробили класний сайт з різними штуками.",
      regards: "Дякуємо колегам, які приймали участь в  проєкті:",
    },
    footer_sections: {
