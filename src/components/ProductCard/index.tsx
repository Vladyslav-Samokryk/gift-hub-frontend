...
export default function ProductCard ({ img, name, type, price, global_rating }: ProductCardType): JSX.Element {
  const [imgLoad, setImgLoad] = useState(false);
  return (
    <div className="m-2 h-fit w-80 rounded-lg border-2 border-black">
