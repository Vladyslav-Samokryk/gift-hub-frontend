export default function UpArrow (): JSX.Element {
  return (
    <button className="absolute bottom-64 right-10 flex h-20 w-20 items-center justify-center rounded-full bg-primary-linear shadow-drop-2" onClick={() => window.scrollTo(0, 0)}>
